...
$pre_test_form = get_field('pre_test', $root_id);

// Redirect if pre-test is not configured
if(!$pre_test_form) {
...
if($lessons) {
    ...
    $lesson_list_html .= '<li class="current"><a href="'.get_permalink( $root_id ).'?type=pre_test">';
