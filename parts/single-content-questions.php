        ...
        <div class="card course-info">
            ...
            <div class="questions-forms">
                ...
                if( empty($quesion_log) ){
                    ...
                    echo do_shortcode( '[gravityform id="'.$form_question.'" title="false" description="false" ajax="true"]' );
                }else{
